...
public class C47_MemberTest {
	...
	public static void main(String[] args) {
		...
		list.add(new Member("신비",20));
		System.out.println("현제 list 의 요소 개수"+list.size());
		System.out.println("리스트 출력");
		System.out.println(list);
		//list.get(i) -> Member객체의 참조값
		System.out.println("list의 요소중 age 필드 값이 25이하 인것만 출력해보기");
		...
		//리스트 요소가 여러개의 필드를 갖는 객체이면 필드값 비교하는 equals예제 입니다.
		System.out.println("4.참고");
		//									indexOf메서드는 제너릭타입이 String, 기본형 래퍼클래스만 사용합니다.
		
		System.out.println("Member 객체로 indexOf 실행:"+ list.indexOf(new Member("나나",20)));
		// -1. 못찾음 (이유: 참조값이 같은것을 찾는 것인데 이것을 필드값 비교해서 찾도록 바꾸어주는 기능 구현이 필요합니다.)
